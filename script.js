...
function show() 
{
    const testemodal = document.querySelectorAll(".modais");
    testemodal.forEach((modal, index) => {
        modal.styl.display = (index === testeModal) ? 'block' : 'none';
    });
    testeModal = (testeModal + 1) % testemodal.length;
}
